  ...
  return (
    <div>
      ...
      <div className='absolute inset-0 bg-white bg-opacity-45'></div>
        <h1 className=' text-3xl md:text-5xl font-bold text-black  relative z-10 md:w-[50vw] leading-normal md:leading-normal'>{props.head1}</h1>
        ...
        <Link to='#section'>
        <div className="flex items-center justify-center w-12 h-12 rounded-full bg-white hover:bg-blue-500 transition-colors duration-300 mx-auto absolute bottom-4 left-[30%] md:left-[50vw]">
          <svg

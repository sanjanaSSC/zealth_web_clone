...
export default function Patients() {
  ...
  return (
    <div>
      ...
      <div className='flex md:pl-[48%] flex-col md:flex-row text-3xl items-center text-center md:items-start md:text-4xl font-bold text-blue-900 py-24 pt-32 bg-gray-100 mt-10'>
